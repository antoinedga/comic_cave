...
--
-- Host: localhost:3306
-- Generation Time: Dec 03, 2019 at 09:56 PM
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='holds artist names';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='holds comic data';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='holds customer and total data for order';

--
-- Dumping data for table `orders`
--

INSERT INTO `orders` (`order_id`, `customer_email`, `total`) VALUES
(1, 'bruce@wayne.bat', '134.95');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='middleman between comics and orders';

--
-- Dumping data for table `order_info`
--

INSERT INTO `order_info` (`oi_id`, `order_id`, `comic_id`, `quantity`, `price`, `ship_date`) VALUES
(1, 1, 6, 4, '119.96', '2019-12-04 13:00:00'),
(2, 1, 7, 1, '14.99', '2019-12-04 13:00:00');
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='holds publisher names';
...
CREATE TABLE `users` (
  ...
  `pass` varchar(70) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL
...
INSERT INTO `users` (`user_id`, `first_name`, `email`, `pass`) VALUES
(1, 'Ant', 'demo@email.com', '$2y$10$.sxHlHx7eDT1VpPgSSRgAOl9TWRn1kUuPg5WszaAxYTk7ZB.Z0.ZK');
...
CREATE TABLE `writers` (
  ...
  `first_name` varchar(20) DEFAULT NULL,
  `last_name` varchar(40) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='holds writer names';
...
--
ALTER TABLE `order_info`
  MODIFY `oi_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `writers`
  MODIFY `writer_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
COMMIT;
